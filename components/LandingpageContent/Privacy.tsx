...
const Privacy = () => {
  return (
    <section id="privacy" className="w-full py-14 relative">
      ...
      ></motion.div>
      <Star src="/icon/graystar.png" className="flex right-[8%] bottom-[24%]" />
      <Star
        src="/icon/lightstarIcon.png"
        className="flex right-[38%] bottom-[28%]"
      />
      <Star
        src="/icon/purplestarIcon.png"
        className="flex right-[32%] bottom-[35%] w-3"
      />
      <Star
        src="/icon/lightstarIcon.png"
        className="flex right-[15%] top-[23%] w-3"
      />
      <Star
        src="/icon/purplestarIcon.png"
        className="flex right-[50%] top-[20%]"
      />
      <Star src="/icon/graystar.png" className="flex left-[26%] top-[5%]" />
      <Star
        src="/icon/purplestarIcon.png"
        className="flex left-[2%] bottom-[33%]"
      />
    </section>
  );
};
